                ...
                <div className="flex flex-col gap-8 w-full">
                    ...
                    <div className="w-full flex flex-col gap-6">
                        <div className="w-full flex flex-col">
                            <p className="text-(--grey) mb-1.5 text-sm">ID площадки</p>
                            <input type="text" placeholder="Введите ID площадки" className="w-full text-base px-4 py-[14px] bg-(--btn-secondary-bg) rounded-2xl outline-none text-(--text-main) placeholder-(--grey)" />
                        </div>
