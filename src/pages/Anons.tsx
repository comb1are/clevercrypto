                ...
                <div className="h-full w-full flex flex-col justify-end">
                    {activeSlide === 0 && (
                        <div className="container h-full flex flex-col justify-end relative mx-auto px-4">
                            <img className="w-full left-0 mb-4" src={isDark ? IMG.anonsCard1Dark : IMG.anonsCard1} alt="" />
                            <h2 className="mb-6 pt-2 font-nagel text-4xl font-medium">Добро пожаловать</h2>
                    ...
                    {activeSlide === 1 && (
                        <div className="container h-full flex flex-col justify-end relative mx-auto px-4">
                            <h2 className="mb-6 pt-2 font-nagel text-4xl font-medium">Принимайте платежи быстро</h2>
                    ...
                    {activeSlide === 2 && (
                        <div className="container h-full flex flex-col justify-end relative mx-auto px-4">
                            <h2 className="mb-6 pt-2 font-nagel text-4xl font-medium">Быстрая регистрация</h2>
                            <p className="mb-9 text-(--grey)">
