...
const CRYPTO_LIST = [
    { id: 1, icon: IMG.paymentCrypto1, title: 'Clever', subtitle: '' },
    { id: 2, icon: IMG.paymentCrypto2, title: 'Ethereum', subtitle: '' },
    { id: 3, icon: IMG.paymentCrypto3, title: 'Bitcoin', subtitle: '' },
    { id: 4, icon: IMG.paymentCrypto4, title: 'USDT', subtitle: 'TRC-20' },
    { id: 5, icon: IMG.paymentCrypto5, title: 'USDT', subtitle: 'ERC-20' },
    { id: 6, icon: IMG.paymentCrypto6, title: 'USDT', subtitle: 'BNB-20' },
    { id: 7, icon: IMG.paymentCrypto7, title: 'USD Coin', subtitle: '' },
    { id: 8, icon: IMG.paymentCrypto8, title: 'Tron', subtitle: '' },
    { id: 9, icon: IMG.paymentCrypto9, title: 'Litecoin', subtitle: '' },
];

export default function PayingByCrypto() {
    const isDark = useTheme();
    const [isDetailModalOpen, setIsDetailModalOpen] = useState(false);
    const [selectedId, setSelectedId] = useState<number>(CRYPTO_LIST[0].id);
                                ...
                                <label key={data.id} className="flex flex-col w-full h-full relative border border-(--border-secondary) rounded-[24px] p-4 gap-3 transition-colors overflow-hidden cursor-pointer ">
                                    ...
                                    <div className="flex flex-col relative z-5 flex-1">
                                        <div className="flex items-center gap-1">
                                            {data.id === 1 && <IconByCrypto41 fill={isDark ? '#E7E7E7' : '#282828'} />}
