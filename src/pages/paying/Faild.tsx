...
export default function PayingFaild() {
    ...
    return (<div className="flex flex-col min-h-screen">
        ...
        <section className="w-full pb-8">
            <div className="w-full px-4 mb-4 flex flex-col gap-3">
                <MainBtn className="w-full flex items-center justify-center gap-2 bg-(--btn-third-bg) text-(--text-main) py-[14px] rounded-[18px] transition-colors hover:bg-white/10">
                    <img src={isDark ? IMG.supportLogoDark : IMG.supportLogo} alt="" className="shrink-0 w-6 h-6" />
                    <span className="font-medium tracking-[0.04em]">Написать в поддержку</span>
                </MainBtn>
                <MainBtn to="/home" className="w-full flex items-center justify-center font-medium gap-2 bg-(--text-main) text-(--bg-main) py-[14px] rounded-[18px]">
