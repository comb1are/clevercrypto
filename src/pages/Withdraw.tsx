        ...
        <section className="flex flex-1 mt-2">
            <div className="flex flex-col flex-1 pt-3 mx-auto px-2 gap-[20px] ">
                ...
                <div className="flex flex-col items-center justify-center ">
                    ...
                    <div className="qr-code bg-(--text-main) py-[10px] px-[20px] rounded-4xl border-glow-blob">
                        ...
                        <h4 className="wrap-break-word max-w-[212px] text-center text-(--bg-main)">bc1qmtkq5g7scre06fgwzjextzn0m2vswsz53scw</h4>
                    </div>
                </div>
