...
const TRANSACTION_LIST: Transaction[] = [
    ...
    { id: 2, title: 'Bitcoin', subtitle: 'Перевод', amount: '-0.534 BTC', usd: '$1,928.40', type: 'transfer' },
    { id: 3, title: 'Bitcoin', subtitle: 'Вывод', amount: '-0.534 BTC', usd: '$1,928.40', type: 'withdrawal' },
    { id: 4, title: 'Bitcoin', subtitle: 'Пополнение', amount: '+1.4919 BTC', usd: '$181,319.56', type: 'deposit' },
    { id: 5, title: 'Bitcoin', subtitle: 'Перевод', amount: '-0.534 BTC', usd: '$1,928.40', type: 'transfer' },
    { id: 6, title: 'Bitcoin', subtitle: 'Вывод', amount: '-0.534 BTC', usd: '$1,928.40', type: 'withdrawal' },
    { id: 7, title: 'Bitcoin', subtitle: 'Пополнение', amount: '+1.4919 BTC', usd: '$181,319.56', type: 'deposit' },
    { id: 8, title: 'Bitcoin', subtitle: 'Перевод', amount: '-0.534 BTC', usd: '$1,928.40', type: 'transfer' },
    { id: 9, title: 'Bitcoin', subtitle: 'Вывод', amount: '-0.534 BTC', usd: '$1,928.40', type: 'withdrawal' },
];
            ...
            <section className="relative">
                ...
                <div className="">
                    ...
                    <div className="grid grid-cols-4 gap-2 mb-4 navigation mx-3 bg-(--bg-card) rounded-[24px] p-3">
                        ...
                        <div className="">
                            <Link to={'/check/aml'} className="w-full flex flex-col items-center text-center gap-2">
                                <div className="icon flex items-center justify-center w-full bg-(--btn-secondary-bg) py-4 px-6 rounded-[18px]">
                        ...
                        {TRANSACTION_LIST.map((data) => {
                            ...
                            return (<li key={data.id} className="transactions-card flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className={clsx('icon flex items-center justify-center shrink-0 rounded-full w-10 h-10', bgColor, reverse)}>
                                        {icon}
                                    </div>
                                    <div>
